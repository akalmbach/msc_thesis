...
\label{fig:ifcb}
\end{figure}
\todo{Any attribution needed here (I think so). Any copyright issue?}
...
\end{figure}
\todo{Can you make these bigger? Use a full page?}
...
\end{figure}
\todo{Maybe point out explicitly that scales are different? Maybe.}
