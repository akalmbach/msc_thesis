...
\todo{I think you need a cartoon here illustration showing graphically how you want this to work or after the paragraph below}
...
\todo{Latter part of the explanation below is very dense and takes a lot of work to follow.  It could use some extra simplification iff you have time, but  it's not critical}
...
\todo{I suggest a full equation that will have a number, in case a reader or review wants to refer to this}
...
Reorganizing the mutual information in this also way reveals how to estimate it from a minibatch of size $M$:\todo{Requires some extra explanation for the casual reader. I do not think you have even used the term minibatch before!}
\begin{equation}
\begin{split}
...
\todo{Could really use a figure above, if you haev time}

\section{Spatial topic prediction model}

\todo{Someplace you need a picture of the camera, an explanation in simple terms of the problem and a cartoon.}
Beyond simply finding any low-dimensional representation of the image space a PTZ camera may encounter \todo{Need to explain this.  What is "PTZ" and how does that relate?  I don't think you even explained yet that you are using the camera axes in any specific way.}, the spatio-temporal topic model is able to learn such a representation that is also spatially coherent. We situate the topic model's neighborhoods in the space of views, meaning that the resulting learned topic priors will form a map of the visually distinct regions in pan-tilt-zoom space.
