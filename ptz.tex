...
\todo[inline]{Supervised learning for a feature function. As an alternative, words could be used to represent something other than spatial objects that may fit better with the spatial smoothness prior.}
