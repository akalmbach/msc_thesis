...
\SetAcknowledgeText{\vspace{-12pt} Studying at McGill has been an incredible journey and a great priviledge, and I would like to thank everyone who made my time here as memorable as it was illuminating. Foremost, I would like to thank my supervisor Gregory Dudek for his guidance, encouragement, and infectious enthusiasm for interesting ideas. I also would like to express my gratitude for labmate, mentor and friend, Yogesh Girdhar, who's work is the starting point of this thesis, and who's own adventures led me to an extremely rewarding semester abroad at Woods Hole Oceangraphic Institution. I'd also like to thank all of the members of the Mobile Robotics Lab; Florian, Juan, Sandeep, Travis, Jimmy, Nikhil, Andrew, Johanna, Lucas, Wei-Di, Karim, Monica, Ed, Scott, Anqi, Malika, Isabelle, Yiannis, Dave, Yogi, and Greg, for building a vibrant, energizing community, and for fruitful collaborations and valuable feedback throughout my studies. I'd like to express extra gratitude to Florian and Juan, for being extra dependable friends and sources of good advice, as well as to Wei-Di, for all his help in our active vision experiments over the past year. I'd also like to express my thanks to my friends outside the lab, Steve, Brian, Matt, and Ben, who helped keep my work connected to the world at large, and who enrich my perspective and my life. Finally, I'd like to thank my family: my girlfriend, Katie, my mother, Faye, my father, Arnold, and my sister Ilana; For their unconditional support and caring, no matter how many times I explained my work by starting from the middle.}%
\Acknowledge%
